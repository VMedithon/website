...
|---|---|---|---|---|---|---|
|| GAP-UI-01 | Dashboard mutations | `Dashboard.tsx` supports core create/edit for finance, forms (with field builder), certificates, people, and settings; certificate background upload and reviewer assignment are still partial | Full CRUD UI for forms, certificates, finance, submissions, and reviewer assignment | Staff cannot complete workflows in the browser | Phase 2 |
